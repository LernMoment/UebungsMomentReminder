...
using UebungsMomentReminder.Properties;
...
namespace UebungsMomentReminder.ViewModels
{
    public class ShellViewModel : Observable
    {
        ...
        public ObservableCollection<HamburgerMenuItem> MenuItems { get; } = new ObservableCollection<HamburgerMenuItem>()
        {
            ...
            new HamburgerMenuGlyphItem() { Label = Resources.ShellLernMailsSubscriberPage, Glyph = "\uE8A5", TargetPageType = typeof(LernMailsSubscriberViewModel) },
        };
